    ...
    <div class="container" style="width: 50%">
        <form action="{{route('kelurahan.store')}}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_kelurahan" id="" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Nama Kelurahan</label>
                <input type="text" name="nama_kelurahan" id="" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
            <div class="mb-3">
