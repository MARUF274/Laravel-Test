    ...
    <div class="container" style="width: 50%">
        <form action="{{route('kecamatan.store')}}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_kecamatan" id="" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Nama Kecamatan</label>
                <input type="text" name="nama_kecamatan" id="" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
